...
struct ProductFormView: View {
    @State private var popProductFormView: Bool = false
    ...
    var body: some View {
        ...
        Form {
            Group {
                ...
                NavigationLink(
                    destination: ProductMaterialFormView(popProductFormView: $popProductFormView, productVM: productVM),
                    isActive: $popProductFormView,
                    label: {
                        HStack {
                            Text("Material")
                            Spacer()
...
struct ProductMaterialFormView: View {
    @Binding var popProductFormView: Bool
